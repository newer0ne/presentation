...
st.markdown(
    """
    Рад приветствовать Вас на странице с проектов
    по подготовке, аналитике и визуализации данных.
    Каждая страница реализована под конкретную прикладную задачу.
    ...
    - «EPP calculation»:
        Разработка калькулятора режимор для обработки методом 
