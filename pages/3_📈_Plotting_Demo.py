...
st.write(
    ...
    отрисовки графика, а генератор случайных чисел в течении 
    нескольких секунд будет регенерировать график , и каждый раз
    как будет нажата кнопка под графиком - он будет обновляться.
