...
if uploaded_ads is not None and uploaded_leads is not None and uploaded_purchases is not None:
    ...
    example_delta['purchase_created_at'] = pd.to_datetime(example_delta['purchase_created_at'], infer_datetime_format=True)
    example_delta['purchase_created_at'] = pd.to_datetime(example_delta['purchase_created_at'], format = "%Y-%m-%d")
