...
if uploaded_ads is not None and uploaded_leads is not None and uploaded_purchases is not None:
    ...
    example_delta['purchase_created_at'] = pd.to_datetime(example_delta['purchase_created_at'], format = "%d-%m-%Y")
    example_delta['created_at'] = pd.to_datetime(example_delta['created_at'], format = "%d-%m-%Y")
